...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(count) =>
      "${Intl.plural(count, zero: 'Ningún elemento seleccionado', one: '1 elemento seleccionado', other: '${count} elementos seleccionados')}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "add_ingredient_error_already_in_list":
        MessageLookupByLibrary.simpleMessage(
          "Uno o más ingredientes ya están en la lista",
        ),
    "add_ingredient_error_unknown": MessageLookupByLibrary.simpleMessage(
      "Ocurrió un error desconocido al agregar el ingrediente",
    ),
    "add_ingredient_success": MessageLookupByLibrary.simpleMessage(
      "Ingrediente(s) agregado(s) exitosamente",
    ),
    ...
    "currency_inr": MessageLookupByLibrary.simpleMessage("Rupia India"),
    ...
    "passwordless_email_error": MessageLookupByLibrary.simpleMessage(
      "Error al enviar el enlace de inicio de sesión. Por favor, inténtalo de nuevo.",
    ),
